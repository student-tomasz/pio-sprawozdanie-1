...
\begin{sidewaystable}
  \centering
  \begin{tabular}{c r *{4}{c}}
    \toprule
    & & \multicolumn{4}{c}{\bf Zadanie} \\
    \cmidrule{3-6}
    % begin: rząd z~tytułami zadań
    & &
    Szablon graficzny (\ref{sec:zadania_szablon}) &
    Dostęp do danych (\ref{sec:zadania_dostep}) &
    Kod serwisu (\ref{sec:zadania_kod}) &
    Zabezpieczenia (\ref{sec:zadania_zabezpieczenia}) \\
